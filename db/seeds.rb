...
ship1 = Ship.create(coordinates: "33,34,35", ship_type: "cruiser", game: game1, user: user1)
ship2 = Ship.create(coordinates: "66,56", ship_type: "destroyer", game: game1, user: user1)
...
ship8 = Ship.create(coordinates: "91,92,93,94" , ship_type: "battleship", game: game1, user: user2)
ship9 = Ship.create(coordinates: "18,28,38,48,58", ship_type: "carrier", game: game1, user: user2)
ship10 = Ship.create(coordinates: "13,14, 15,16", ship_type: "battleship", game: game1, user: user2)
...
ship18 = Ship.create(coordinates: "91,92,93,94" , ship_type: "battleship", game: game2, user: user2)
ship19 = Ship.create(coordinates: "18,28,38,48,58", ship_type: "carrier", game: game2, user: user2)
ship20 = Ship.create(coordinates: "13,14, 15,16", ship_type: "battleship", game: game2, user: user2)
